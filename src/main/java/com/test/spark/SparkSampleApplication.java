...
public class SparkSampleApplication implements CommandLineRunner {
    ...
    public void run(String... arg0) throws Exception {
        ...
        File tempFile = new File("src/main/resources/data.json");
        boolean exists = tempFile.exists();
        System.out.println("---------------------------------------------------------------");
        System.out.println("현재 프로젝트의 경로 : "+exists );
        System.out.println(sparkSession.read().json("src/main/resources/data.json").count());
