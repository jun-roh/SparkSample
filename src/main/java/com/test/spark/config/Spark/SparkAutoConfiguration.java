...
public class SparkAutoConfiguration {
    ...
    public SparkAutoConfiguration(SparkProperties sparkProperties){
    ...
    public SparkConf sparkConf(){
        java.util.Optional.ofNullable(sparkProperties.getAppName()).orElseThrow(() -> new IllegalArgumentException("Spark Conf Bean not created. App Name not defined."));
